...
## :pushpin: Content
- :dart: [Strategy](#dart-strategy)
- :eyes: [Observer](#eyes-observer)
- :bouquet: [Decorator](#bouquet-decorator)
- :factory: [Factory](#factory-factory)
- :standing_person: [Singleton](#standingperson-singleton)
- :joystick: [Command](#joystick-command)
- :electric_plug: [Adapter](#electricplug-adapter)
- :door: [Facade](#door-facade)
- :clipboard: [Template](#clipboard-template)
- :repeat: [Iterator](#repeat-iterator)
